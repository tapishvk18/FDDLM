...
del X1, X2, X3, X4
print("CNN X,y created\n")
cnn_history, cnn_confusion_matrices = get_model_performance(model_func= CNN_Model, X= X, y= y, epochs=100)
heatmap_drawing(cnn_confusion_matrices,"CNN Hold out","CNN")
save_history("./history/cnn_history.npy", cnn_history)
graph_drawing(cnn_history,"CNN Hold out","CNN")
get_history_summary(cnn_history,"CNN Hold out","CNN")