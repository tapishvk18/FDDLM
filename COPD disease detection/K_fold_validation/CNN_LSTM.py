...
def CNN_LSTM_Model(data):
    ...
    model.add(layers.LSTM(16, activation="tanh", name="LSTM"))
...
X = X.reshape(X.shape[0], 600, 120)
y = y.reshape(y.shape[0], 1)
print("CNN + LSTM X,y created\n")
cnn_lstm_history, cnn_lstm_confusion_matrices = get_model_performance(model_func= CNN_LSTM_Model, X= X, y= y, epochs=100)
np.save("./heatmaps/cnn_lstm_cfs.npy", cnn_lstm_confusion_matrices)
